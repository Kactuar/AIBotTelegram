...
* Только пользователи, чьи ID указаны в `TELEGRAM_ALLOWED_USER_IDS`, могут запускать обработку. При первом входе они получают 100 тестовых токенов; создание проекта резервирует 23 токена, а если ИИ-сервис завершится с ошибкой, токены возвращаются.
